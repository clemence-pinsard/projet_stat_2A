...
Les paramètres a et c gouvernent l'amplitude de la courbe mais agissent en sens opposés : a détermine le plateau vers lequel tend le terme montant et tire le pic vers le haut, tandis que c contrôle l'amplitude du terme descendant et l'abaisse. Leur rapport conditionne ainsi directement la valeur maximale atteinte par P(t). Le rapport $\frac a c$ conditionne la forme du pic : si c≪a, le terme ascendant domine et a fixe seul l'ordre de grandeur du pic; si au contraire c≫ac, le terme descendant est de grande amplitude et le pic résulte d'un équilibre plus prononcé entre les deux composantes. Dans tous les cas, la condition nécessaire et suffisante à l'existence d'un pic est ab>cd.
...
notamment le point isolé à 40 ans (environ 20,7 km/h) qui s'écarte nettement de lacourbe.
...
=======
## Modèles de Moore {.unnumbered}{#sec-annexe-courbes-Moore}
...
## Modèles IMAP {.unnumbered} {#sec-annexe-courbes-IMAP}
...
## Comparaison des modèles {.unnumbered} {#sec-annexe-comparaison-modeles}
