...
deux modèles pour l'ensemble des disciplines. Les deux modèles convergent
vers des estimations globalement cohérentes, avec des écarts souvent
inférieurs à 2 ans. Quelques divergences notables méritent cependant
d'être soulignées.
...
Pour les disciplines d'endurance longue, les deux modèles s'accordent
remarquablement : au marathon, Moore estime un pic à 29,7 ans chez les
hommes et 29,3 ans chez les femmes, contre 29,5 et 29,8 ans pour IMAP ---
un écart inférieur à 0,5 an. Cette convergence renforce la robustesse des
estimations pour cette discipline.

Les divergences les plus importantes apparaissent dans les disciplines de
sprint et de demi-fond. Au 100m hommes, Moore estime le pic à 27,6 ans
contre 29,2 ans pour IMAP ; au 10 000m hommes, l'écart est inverse avec
22,3 ans (Moore) contre 24,9 ans (IMAP). Ces différences s'expliquent
par la structure paramétrique distincte des deux modèles, qui peuvent
converger vers des optima locaux différents sur une fenêtre d'observation
restreinte à 16--40 ans.

Pour les lancers, les deux modèles s'accordent sur des pics tardifs,
au-delà de 28 ans : au lancer du disque hommes, Moore donne 30,9 ans et
IMAP 30,0 ans ; au lancer du poids hommes, 29,9 ans contre 28,7 ans.
Cette convergence est cohérente avec la littérature qui souligne le rôle
de la force maximale, qui atteint son pic plus tardivement que la vitesse
explosive \cite{Allen2015}.

#### Qualité d'ajustement : RMSE, AIC et BIC {.unnumbered}

Le Tableau @tbl-comparatif-rmse présente les RMSE obtenus par les deux
modèles. Dans l'ensemble, les erreurs résiduelles sont très proches entre
Moore et IMAP, ce qui confirme que les deux formulations capturent des
dynamiques similaires sur la fenêtre d'observation. On note néanmoins
quelques avantages ponctuels d'IMAP : au marteau hommes, le RMSE passe
de 1,986 (Moore) à 1,319 (IMAP), soit une réduction de 34 % ; au poids
femmes, de 0,446 à 0,226, soit une réduction de 49 % ; au 10 000m hommes,
de 0,550 à 0,277. À l'inverse, Moore présente un RMSE légèrement inférieur
sur plusieurs disciplines de course (100m, 200m, 800m), où la variance
résiduelle est plus élevée pour IMAP.
...
La comparaison des critères AIC et BIC (Tableaux @tbl-comparatif-aic
et @tbl-comparatif-bic) confirme cette absence de dominance systématique.
IMAP obtient de meilleurs critères sur le marathon hommes (AIC de -33,0
contre -20,8 pour Moore), le 10 000m hommes (11,7 contre 43,4) et les
épreuves combinées (271,1 contre 275,0 chez les hommes ; 297,9 contre
308,4 chez les femmes). Moore présente en revanche de meilleurs critères
sur la majorité des disciplines de course courte et de demi-fond.

Dans l'ensemble, aucun des deux modèles ne domine systématiquement l'autre.
Ce résultat suggère que les deux formulations --- l'une purement empirique
(Moore), l'autre biologiquement motivée (IMAP) --- capturent des dynamiques
comparables sur la fenêtre 16--40 ans. La richesse interprétative des
paramètres du modèle IMAP, ancrés dans une théorie biologique cellulaire,
constitue en ce sens un argument complémentaire en sa faveur, indépendamment
des seuls critères statistiques.
