...
Il convient toutefois de noter certaines limites structurelles : un déséquilibre dans la répartition des athlètes par âge, avec une sous-représentation des athlètes de plus de 35 ans, ainsi qu'une possible hétérogénéité dans la qualité de l'enregistrement des données selon les périodes et les pays. La sous-représentation des athlètes de plus de 35 ans sera un détail dont il faudra tenir compte puisqu'elle est dûe au fait que les données dont nous disposons correspondent aux perfromances des meilleurs athlètes chaque saison et donc cela explique pourquoi les athlètes de 35 ans sont peu présents comparés à des athlètes plus jeunes. Ces biais potentiels seront pris en compte dans notre analyse et discutés dans l'interprétation des résultats.
...
-   **Age_Pic_Obs :** Variable quantitative qui correspond à l'âge auquel l'athlète a réalisé son record personnel absolu au cours de sa carrière. Il s'agit de la variable dépendante centrale, elle a été obtenue comme l'âge auquel la performance maximale a été réalisée par chaque athlète. \vspace{5pt}
