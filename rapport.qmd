...
-   **Sex :** Pour comparer les performances entre les femmes et les hommes. \vspace{5pt}
-   **Famille :** Regroupement des disciplines par famille (sprints, lancers, sauts, haies, marche, épreuves combinées, marathon, demi-fond, 5000-10000) \vspace{5pt}
-   **Discipline :** Pour observer les ressemblances et différences entre les différentes disciplines de l'athlétisme. \vspace{5pt}
-   **Age :** Age de l'athlète lorsqu'il a réalisé la performance correspondante, elle est calculée en faisant la différence entre l'année au cours de laquelle la performance a été réalisée et l'année de naissance de l'athlète (extraite de sa date de naissance). Notre variable Age est donc une approximation de l'âge exact car nous ne connaissons pas la date exacte à laquelle la performance a été réalisée. \vspace{5pt}
-   **Age_Pic_Obs :** L'âge auquel l'athlète a réalisé son record personnel absolu au cours de sa carrière. Il s'agit de notre variable dépendante centrale. \vspace{5pt}
-   **mark_numeric :** Meilleure performance d'un athlète sur une saison au format numérique (en seconde ou mètre selon la discipline). \vspace{5pt}
-   **meilleure_perf_km_par_h :** Conversion de la performance en kilomètre par heure pour les disciplines de courses ou marche afin d'avoir des valeurs positives à maximiser dans nos modèles.
...
## Distributions par famille {#sec-annexe-hist-fam}
...
## Diagnostics de normalité par famille (QQ-plots) {#sec-annexe-qqplots}
...
## Résultats détaillés des tests de normalité

### Échelle des familles de disciplines
...
### Échelle des épreuves individuelles
...
## Résultats complets des tests de Wilcoxon par familles
