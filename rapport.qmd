...
\noindent L'équation @eq-moore est un modèle à double exponentielle, constitué de deux composantes :\
...
#### Ajustement du modèle de Moore à nos données pour chaque discipline {#sec-annexe-courbes-Moore .unnumbered} 
...
#### Ajustement du modèle IMAP à nos données pour chaque discipline {#sec-annexe-courbes-IMAP .unnumbered} 
